    ...
    >
      ...
      <div className="max-w-7xl mx-auto md:h-16 flex justify-between items-center px-4 md:px-6">
        ...
        <a href="./index.html" className="flex items-center space-x-2">
          <img src={orglogo} alt="Logo" className="h-8 md:h-10 rounded-full" />
          <span className={`text-base md:text-2xl font-bold font-serif ml-2 tracking-tight transition-colors duration-300 ${isScrolled ? 'text-primary-700' : 'text-primary-800'}`}>
            Cake Fairy
          </span>
        </a>
        <a
